...
* Bump rendition and typescript dependencies [Stevche Radevski]
* Make all inputs emphasized, select network correctly [Stevche Radevski]
* Upgrade to latest rendition, minor changes based on review [Stevche Radevski]
* Upgrade rendition to 8.8.0 [Stevche Radevski]
* Prevent source maps from being generated when building UI [Stevche Radevski]
* Fix missing colon [Stevche Radevski]
